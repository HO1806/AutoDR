...
HTML_FILE    = Path("autodr-research-prompts-v2.html")
OUTPUT_DIR   = Path("output")
RESEARCH_DIR = OUTPUT_DIR / "research"
SYNTHESIS_FILE = OUTPUT_DIR / "AUTODR_SYNTHESIS.md"
...
You have just received the results of 27 deep-research reports about building "AutoDR" — 
...
2. **Morocco Market Reality** — What are the 5 most critical validated facts about Morocco 
   that should change how AutoDR is built vs. a Western-market product?

3. **Niche Recommendation** — Which niche(s) should AutoDR launch in first, and why? 
...
5. **Competitive Position** — What is AutoDR's unique opening in the Morocco market? 
...
6. **Paperclip Configuration Recommendations** — Concrete recommended structure for the 
   AutoDR multi-agent company: org chart, adapter per department, heartbeat settings, budgets.
...
9. **Critical Risks & Open Questions** — What did the research NOT resolve? What are the 
   highest-uncertainty bets AutoDR is making, and how should they be validated?

10. **Recommended First 90 Days** — A concrete action sequence for the first 90 days of 
    building and launching AutoDR in Morocco.
...
"""
    ...
    try:
        ...
        final_md = f"""# AutoDR — Strategic Research Synthesis
...
# ── Entry point ────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description="AutoDR Gemini Research Pipeline")
